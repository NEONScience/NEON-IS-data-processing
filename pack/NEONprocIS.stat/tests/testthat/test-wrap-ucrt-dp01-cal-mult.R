##############################################################################################
#' @title Unit test of wrap.ucrt.dp01.cal.mult.R
#'
#' @author
...
#'
#' Refer to wrap.ucrt.dp01.cal.mult.R for the details of the function.
#'
...
#' ucrt <- NEONprocIS.stat::wrap.ucrt.dp01.cal.mult(data=data,VarUcrt='temp',ucrtCoef=ucrtCoef)
#'
#' @seealso \link[NEONprocIS.stat]{wrap.ucrt.dp01}
#' @seealso \link[NEONprocIS.stat]{wrap.ucrt.dp01.cal.mult.fdas.rstc}
...
test_that("Unit test of wrap.ucrt.dp01.cal.mult.R", {
  ...
  ucrt <- NEONprocIS.stat::wrap.ucrt.dp01.cal.mult(data = data, VarUcrt = 'linePAR',ucrtCoef = ucrtCoef,
                                                   ucrtData=NULL)
