...
# Unit test of wrap.ucrt.dp01.cal.mult.envsc.R
test_that("Unit test of wrap.ucrt.dp01.cal.mult.envsc.R", {
  
  data <- data.frame(readout_time=as.POSIXct(c('2019-01-01 00:00','2019-01-01 00:01','2019-01-01 00:02'),tz='GMT'),
                     VSWCsoilSpecificMean=c(827.7,827.8,831.3))
  ucrtCoef <- list(list(term='VSWCsoilSpecificMean',start_date=as.POSIXct('2019-01-01',tz='GMT'),end_date=as.POSIXct('2019-01-02',tz='GMT'),Name='U_CVALA3_soilSpec',Value='0.0388'))

  # Happy Path 1, all the params to wrap.ucrt.dp01.cal.mult.envsc have the correct values
 
  ucrt <- NEONprocIS.stat::wrap.ucrt.dp01.cal.mult.envsc(data=data,VarUcrt='VSWCsoilSpecificMean',ucrtCoef=ucrtCoef,ucrtData=NULL)
