...
# Unit test of def.ucrt.fdas.rstc.poly.R
test_that("Unit test of def.ucrt.fdas.rstc.poly.R", {
  # Happy path
  #
  ...
  testthat::expect_equal(c(2.460012,3.690012,4.920012,6.150012),uncertainty$data$ucrtFdas[2:5],tolerance = 1E-6)
  ...
  uncertainty <- NEONprocIS.cal::def.ucrt.fdas.rstc.poly(data = data, 
                                                    varUcrt='data', 
  ...
  uncertainty <- try(NEONprocIS.cal::def.ucrt.fdas.rstc.poly(data = data, varUcrt='data2', calSlct=calSlct), silent = TRUE)
  testthat::expect_true((class(uncertainty)[1] == "try-error"))
  ...
  uncertainty <- try(NEONprocIS.cal::def.ucrt.fdas.rstc.poly(data = data, varUcrt='data', calSlct=calSlct), silent = TRUE)
  ...
  uncertainty <- try(NEONprocIS.cal::def.ucrt.fdas.rstc.poly(data = data[,-1], varUcrt='data', calSlct=calSlct), silent = TRUE)
  ...
  uncertainty <- try(NEONprocIS.cal::def.ucrt.fdas.rstc.poly (data = data, 
                                                         varUcrt='data', 
                                                         calSlct=calSlct),
                     silent=TRUE)
