##############################################################################################
#' @title Unit test of NEON calibration conversion (def.cal.conv.poly.b)
...
test_that("testing calibration conversion", {
  ...
  testFileCal = c("calibration33_B.xml","calibration33_B_validAfter.xml")
  ...
  calibrated <-
    NEONprocIS.cal::def.cal.conv.poly.b(data = data, varConv='data', calSlct=calSlct)
  ...
  calibrated <- NEONprocIS.cal::def.cal.conv.poly.b(data = data, varConv='data', calSlct=calSlct)
  ...
  calibrated <- NEONprocIS.cal::def.cal.conv.poly.b(data = data, 
                                                  varConv='data', 
  ...
  calibrated <- try(NEONprocIS.cal::def.cal.conv.poly.b(data = data, varConv='data2', calSlct=calSlct), silent = TRUE)
  ...
  calibrated <- try(NEONprocIS.cal::def.cal.conv.poly.b(data = data, varConv='data', calSlct=calSlct), silent = TRUE)
  ...
  calibrated <- try(NEONprocIS.cal::def.cal.conv.poly.b(data = data[,-1], varConv='data', calSlct=calSlct), silent = TRUE)
  ...
  calibrated <- try(NEONprocIS.cal::def.cal.conv.poly.b (data = data, 
                                                       varConv='data', 
                                                       calSlct=calSlct),
                    silent=TRUE)
