...
test_that("fixing the badtime values",
          {
            data <- NEONprocIS.base::def.read.parq(NameFile ="tests/testthat/def.rcd.fix.miss.na/testdata.parquet")
            inputfilepaths <- c('tests/testthat/def.rcd.fix.miss.na/testdata.parquet', '~/git/NEON-IS-data-processing/pack/NEONprocIS.base/tests/testthat/def.rcd.miss.na/valid_files/testflagsdata.parquet')
