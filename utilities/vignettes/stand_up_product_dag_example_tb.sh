...
git_path_pipelines='/home/NEON/tburlingame/GitHub/NEON-IS-data-processing/pipe'
git_path_avro='/home/NEON/tburlingame/GitHub/NEON-IS-avro-schemas'
git_path_avro_l0='/home/NEON/tburlingame/GitHub/neon-avro-schemas'
...
pachctl put file $source_type'_site_list'@master:/site-list-kafka.json -f $spec_path_source_type/site-list-kafka.json
pachctl put file $source_type'_site_list'@master:/site-list-trino.json -f $spec_path_source_type/site-list-trino.json
...
pc start commit pluvio_avro_schemas@master
pc put file -r pluvio_avro_schemas@master:/pluvio -f ~/GitHub/NEON-IS-avro-schemas/avro_schemas/pluvio
pc finish commit pluvio_avro_schemas@master

pc start commit precipWeighingv2_avro_schemas@master
pc put file -r precipWeighingv2_avro_schemas@msater:/precipWeighingv2 -f ~/GitHub/NEON-IS-avro-schemas/avro_schemas/precipWeighingv2
pc finish commit precipWeighingv2_avro_schemas@master

pc create repo precipBucket_avro_schemas
pc start commit precipBucket_avro_schemas@master
pc put file -r precipBucket_avro_schemas@master:/precipBucket -f ~/GitHub/NEON-IS-avro-schemas/avro_schemas/precipBucket
pc finish commit precipBucket_avro_schemas@master
