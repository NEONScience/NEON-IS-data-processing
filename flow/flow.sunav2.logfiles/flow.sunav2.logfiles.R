##############################################################################################
#' @title Workflow for SUNA Log File Processing

#' @author
#' Nora Catolico \email{ncatolico@battelleecology.org}
#' Bobby Hensley \email{hensley@battelleecology.org}

#' @description Workflow. Validates, cleans, and formats sunav2 log files into daily parquets.
#'
#' The arguments are: 
#' 
...
#' @examples
#' flow.sunav2.logfiles <- function(FileIn = "~/pfs/sunav2_logjam_load_files/20349/logjam_prod_20349_0b05a4c0da3bb05af840fece674fe34c.csv",
#'                               DirOut="~/pfs/out",
#'                               SchmDataOut=NULL,
#'                               log=log)
    ...
    withCallingHandlers(
      ...
      error = function(err) {
        ...
        NEONprocIS.base::def.err.datm(
          ...
          DirDatm=base::dirname(idxFileIn),
