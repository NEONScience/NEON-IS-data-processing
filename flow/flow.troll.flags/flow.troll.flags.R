...
#' @description Workflow. Flags all sensr streams for the Level Troll 500 and Aqua Troll 200 when pressure is below zero.
...
#' arg <- c("DirIn=$DIR_IN","DirOut=~/pfs/out","SensTermPressure=pressure","SensTermTemp=temperature","SensTermCond=conductivity","FileSchmQf=~/R/NEON-IS-avro-schemas/dp0p/flags_troll_specific.avsc")
