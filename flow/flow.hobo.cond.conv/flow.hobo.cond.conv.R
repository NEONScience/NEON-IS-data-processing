##############################################################################################
#' @title Workflow for Hobo Conductivity Conversion

#' @author
#' Nora Catolico \email{ncatolico@battelleecology.org}

#' @description Workflow. Flags conductivity for the Hobo when temperature stream is missing. 
...
#' Sys.setenv(DIR_IN='~/pfs/hobou24_calibration_group_and_convert')
#' Sys.setenv(DIR_IN='~/pfs/hobou24_logjam_assign_clean_files/hobou24/2022/06/20/49150')
