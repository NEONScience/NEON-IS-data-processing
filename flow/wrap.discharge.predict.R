...
wrap.troll.uncertainty <- function(DirInWch=NULL,
  ...
  dirBaM <- "/home/NEON/nickerson/R/NEON-IS-data-processing/flow/flow.discharge.predict/BaM_beta/" # devissom
  ...
  for(c in 1:length(curveID)){
    ...
    setwd(dirBaM)
    system2("/home/NEON/nickerson/R/NEON-IS-data-processing/flow/flow.discharge.predict/BaM_beta/BaM") # Linux executable
