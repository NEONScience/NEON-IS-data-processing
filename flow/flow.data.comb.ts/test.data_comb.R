...
source("data_comb.R")
  ...
  test_that(
    ...
    "Data Comb creates combined file",
    {
      ...
      DirEXTENSION <- "01/02/water-quality-283/exoconductivity/CFGLOC110700/stats/SENSOR000316_2019-01-02_basicStats_100.avro"
  ...
  test_that(
    ...
    "No output directory when there are no datums",
    {
      ...
      data_combine(DirIn = DirIn, DirOut = DirOut, DirComb = DirComb, NameDirCombOut = NameDirCombOut, NameVarTime = NameVarTime,
                   ColKeep = ColKeep, NameFileSufx = NameFileSufx)
 ...
 test_that(
    ...
    "Data Comb creates combined file with shortest name",
    {

       DirIn <- "tests/test_input/waterQuality_exoconductivity_data_uncertainty_group/shortest"
       DirOut <- "tests/test_output/pfs/out"
       FileSchmComb <- "tests/test_input/avro_schemas/dp01/waterQuality_exoconductivity_dp01_stats.avsc"
       DirComb <- c("data", "uncertainty_data")
       NameDirCombOut <- "stats"
       ...
       ColKeep <- c("readout_time", "readout_time", "specificConductance", "specificConductance_ucrtExpn")
       NameFileSufx <- "_basicStats_100"
       DirEXTENSION <- "/01/02/water-quality-283/exoconductivity/CFGLOC110700/stats/316_uncert_basicStats_100.avro" 
