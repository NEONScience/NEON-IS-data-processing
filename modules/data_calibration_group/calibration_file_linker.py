...
class CalibrationFileLinker(object):
    ...
    def __init__(self, *, calibration_path: Path,
        ...
        :param source_type_index: The source type index in the calibration path.
        :param source_id_index: The source ID index in the calibration path.
        :param stream_index: The stream index in the calibration path.
        """
        self.calibration_path = calibration_path
        self.calibration_source_type_index = source_type_index
        self.calibration_source_id_index = source_id_index
        self.calibration_stream_index = stream_index
