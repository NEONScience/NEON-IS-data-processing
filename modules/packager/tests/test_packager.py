...
class Packager(TestCase):
    ...
    def setUp(self):
        ...
        self.data_file_1 = Path(self.data_path,
                                '24/NEON.D10.CPER.DP1.00041.001.001.501.001.ST_1_minute.2019-05-24.basic.csv')
        self.data_file_2 = Path(self.data_path,
                                '25/NEON.D10.CPER.DP1.00041.001.001.501.001.ST_1_minute.2019-05-25.basic.csv')
    ...
    def test_package(self):
        package(data_path=self.data_path,
