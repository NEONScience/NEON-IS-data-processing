...
def get_parent(connection, named_location_id: int):
    """
...
def assign_parent(connection, parent_id: int, child_id: int):
    """
...
def assign_to_same_parent(connection, source_named_location_id: int, assignable_named_location_id: int):
    """
...
def get_location_tree(connection, parent_id: int, child_id: int):
    """
