...
def get_assets_at_location(connection, named_location_id: int):
    """
...
def assign_assets(connection, named_location_id: int, cloned_locations: list):
    """
...
def assign_measurement_streams(connection, named_location_id: int, cloned_location_id: int, sensor_type: str):
    """
