...
import sys
from logjam_loader.get_avro_schema_name import get_avro_schema_name
from logjam_loader.get_logjam_stream_name import get_logjam_stream_name
...
def load() -> None:
    ...
    with closing(DbConnector(db_config)) as connector:
        ...
        try:
            ...
            print("Starting New Datum in the load_all_logjam_files pipeline ")
                ...
                if path.is_file():
                    ...
                    with blob.open("r") as f:
                        ...
                        if ((avro_schema_name != None) and (avro_schema_name == sensor_type)):
                            stream_id = root.find('Streamlogjam').find('StreamID').text
                            stream_name = get_logjam_stream_name(connector.get_connection(), avro_schema_name,
                                                                      stream_id)
