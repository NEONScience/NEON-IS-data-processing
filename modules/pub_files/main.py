...
import pub_files.input_files.file_processor as input_file_processor
...
def main() -> None:
    ...
    with closing(DbConnector(db_config)) as connector:
        ...
        for package_type in ['basic', 'expanded']:
            # get required metadata from the input files and link the files into the output directory
            file_metadata = input_file_processor.process_files(in_path=config.in_path,
