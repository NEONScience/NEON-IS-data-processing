...
from pub_files.database.file_variables import make_get_is_science_review_variables, make_get_sensor_position_variables
    ...
    with closing(DbConnector(db_config)) as connector:
        ...
        for root, dirs, files in os.walk(config.in_path):
            ...
            if len(datum_path.parts) == (config.in_path_parse_index + 4):
                ...
                location_datum_path = Path(*location_path_base,
                                           datum_parts.year,
                                           datum_parts.month,
                                           '01',
                                           datum_parts.site)
                ...
                publication_package: PublicationPackage = process_files(
                    in_path=datum_path,
                ...
                for package_type in publication_package.package_metadata:
                    ...
                    positions_path = SensorPositionsFile(
                        location_path=location_datum_path,
                    ...
                    science_review_file: ScienceReviewFile = write_science_review_file(
                        ...
                        package_type=package_type,
                        timestamp=timestamp,
                        get_file_variables=make_get_is_science_review_variables(connector),
                    ...
                    variables_path = variables_file.write_file(
                        ...
                        get_sensor_position_variables=make_get_sensor_position_variables(connector),
                        get_term_variables=make_get_term_variables(connector)
                    )
                    # write readme file
                    readme_path = readme_file.write_file(
                        out_path=file_metadata.package_output_path,
                        file_metadata=file_metadata,
                    ...
                    file_metadata.manifest_file.add_metadata_files(
