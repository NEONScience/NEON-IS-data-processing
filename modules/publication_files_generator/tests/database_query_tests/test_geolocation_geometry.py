...
from publication_files_generator.database_queries.geolocation_geometry import get_geometry, get_formatted_coordinates
...
class LocationGeometryTest(DatabaseBackedTest):
    ...
    def test_get_geometry(self):
        ...
        coordinates = get_formatted_coordinates(geometry)
