...
from publication_files.file_generators.variables_file import write_file
...
class VariablesFileTest(TestCase):
    ...
    def test_write_file(self):
        ...
        real_path = Path(root, 'variables_test_files', 'publication_workbook_water_quality.txt')
