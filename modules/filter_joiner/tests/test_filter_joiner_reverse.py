...
class FilterJoinerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.expected_path_1 = Path('dir2/dir1/file_1.txt')
        self.expected_path_2 = Path('dir2/dir1/file_2.txt')
        self.expected_path_3 = Path('dir2/dir1/file_3.txt')
        ...
        config_file_path = Path(os.path.dirname(__file__), 'config-reverse.yaml')
