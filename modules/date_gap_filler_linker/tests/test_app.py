...
class AppTest(TestCase):
    ...
    def check_output(self):
        ...
        self.assertTrue(Path(self.out_path, self.metadata_1, 'flags',
                             'prt_CFG123_2019-01-01_flagsCal.parquet').exists())
        ...
        self.assertTrue(Path(self.out_path, self.metadata_2, 'flags',
                             'prt_CFG123_2019-01-02_flagsCal.parquet').exists())
        ...
        self.assertFalse(Path(self.out_path, self.metadata_3, 'flags',
                              'prt_CFG123_2019-01-03_flagsCal.parquet').exists())
